...
/**
 * Last-In, First-Out (LIFO) cost-basis strategy.
 * Sells consume the newest available acquisition lots first.
 */
@Component
public class LifoCostBasisStrategy implements CostBasisStrategy {
